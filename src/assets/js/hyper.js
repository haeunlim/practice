...
function ($) {
    ...
    AdvanceFormApp.prototype.initSelect2 = function () {
        ...
        AdvanceFormApp.prototype.initDateRange = function () {
            ...
            // 팝업 등록 데이터 피커
            $('#daterangetime').daterangepicker(dateTimePickerOptions);
            // 사업 설문지 등록 데이터 피커
            $('#daterangetime2').daterangepicker({
                startDate: start,
                endDate: end,
                timePicker24Hour: true,
                timePickerIncrement: 15,
            ...
            var defaultRangeOptions = {
                ...
                ranges: {
                    ...
                    '2개월': [moment().subtract(2, 'month'), moment()],
            ...
            $('[data-toggle="date-picker-range"]').each(function (idx, obj) {
                ...
                $(obj).daterangepicker(objOptions, function (start, end) {
                    if (target)
                        $(target).html(start.format('YYYY' + '-' + 'MM' + '-' + 'DD') + ' ~ ' + end.format('YYYY' + '-' + 'MM' + '-' + 'DD'));
                });
            });
            $('li[data-range-key="Custom Range"]').text('직접선택');
        },
