        ...
        LeftSidebar.prototype.initMenu = function () {
            ...
            if ($(".side-nav").length) {
                ...
                $(".side-nav a").each(function () {
                    ...
                    }else if(pageUrl.includes('main') == true){
                        $('.side-nav-item.home').addClass('menuitem-active');
                    }else if (pageUrl.includes('board_inquiry_list') == true) {
            ...
            // page title script
            function page_title() {
                var depth02Text = $(".side-nav-second-level .menuitem-active a.active .depth02_text").text();
                var depth01Text = $(".side-nav-item.menuitem-active .side-nav-link .depth01_text").text();

                var $topnavDep1 = $('.breadcrumb-item.depth01 a');
                var $topnavDep2 = $('.breadcrumb-item.depth02');
                var $category1 = $('.page-title-box .category1');
                var $category2 = $('.page-title-box .category2');
                if ($category1.text() == '@@title') {
                    if (depth02Text.includes('회원관리') == true) {
                        $category1.text(depth02Text.replace('회원관리', ''));
                        $topnavDep2.text(depth02Text.replace('회원관리', ''));
                    }else{
                        $category1.text(depth02Text);
                        $topnavDep2.text(depth02Text);
                    }

                }
                if($category2.text() == '@@category2@@category2' || $category2.text() == '@@category2'){
                    $category2.remove();
                }
                $topnavDep1.text(depth01Text);
            }
            page_title()
